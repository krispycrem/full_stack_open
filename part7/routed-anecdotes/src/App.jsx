...
const About = () => (
  <div>
    ...
    <em>An anecdote is a brief, revealing account of an individual person or an incident.
      ...
      details of a short narrative. An anecdote is "a story with a point."</em>
    <p>Software engineering is full of excellent anecdotes, at this app you can find the 
      best and add more.</p>
  </div>
)
...
const Footer = () => (
  <div>
    ...
    See <a href='https://github.com/fullstack-hy2020/routed-anecdotes/blob/master/src/App.js'>
      https://github.com/fullstack-hy2020/routed-anecdotes/blob/master/src/App.js</a> 
      for the source code.
  </div>
)
  ...
  return (
    <Router>
      <div>
        ...
        <Menu />
        {notification && <div style={{ border: 'solid', padding: 10, borderWidth: 1 }}>{notification}</div>}
        <Routes>
